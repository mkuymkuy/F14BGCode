 ...
 *
 */
public class InnoCustom066P1Listener extends InnoChooseSpecificCardListener {

	public InnoCustom066P1Listener(InnoPlayer trigPlayer,
	...
	protected boolean canEndResponse(InnoGameMode gameMode, InnoPlayer player) {
		//转移2张后结束..
		if(this.getSelectedCards().size()>=2){
			return true;
		}
