...
/**
 * #027-医药 实际执行效果的监听器(选择计分区中最低时期的1张牌给对方)
 * 
 * @author F14eagle
 *
 */
public class InnoCustom027P2Listener extends InnoChooseSpecificCardListener {

	public InnoCustom027P2Listener(InnoPlayer trigPlayer,
	...
	protected void processChooseCard(InnoGameMode gameMode, InnoPlayer player,
		...
		gameMode.getGame().playerAddScoreCard(this.getCurrentPlayer(), resultParam);
	}
