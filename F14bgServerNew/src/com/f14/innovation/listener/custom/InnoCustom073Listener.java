 ...
 *
 */
public class InnoCustom073Listener extends InnoCommonConfirmListener {

	public InnoCustom073Listener(InnoPlayer trigPlayer,
	...
	protected void doConfirm(InnoGameMode gameMode, BgAction action)
		...
		List<InnoCard> scoreCards = new ArrayList<InnoCard>(player.getScores().getCards());
		//允许空换!!
		if(!handEmpty){
