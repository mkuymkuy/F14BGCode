...
public class CmdFactory {
	 ...
	 * @return
	 */
	public static ByteCommand createClientCommand(String content){
		return CommandFactory.createCommand(CmdConst.CLIENT_CMD, 0, content);
	}
	 ...
	 * @return
	 */
	public static BgResponse createClientNotifyResponse(int code, NotifyType notifyType){
		BgResponse res = new BgResponse(CmdConst.CLIENT_CMD, code, -1, false);
		res.setPublicParameter("notifyType", notifyType);
		return res;
	}
